...
const ContactForm = () => {
  return (
      <>
           <div className="tp-contact-area grey-bg pt-120 pb-120 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".5s">
               ...
               <div className="row">
                  <div className="col-xl-6 col-lg-6">
                     <div className="contact-us-sction-box mb-60">
                        ...
                        <h3 className="tp-section-title-xs">Let’s Work <br/> Together.</h3>
                     </div>
                     <div className="contact-info">
                        ...
                        <Link to="https://www.google.com.bd/maps/place/United+States/@37.2756214,-104.656551,5z/data=!3m1!4b1!4m5!3m4!1s0x54eab584e432360b:0x1c3bb99243deb742!8m2!3d37.09024!4d-95.712891" target="_blank">
                          Wisconsin Ave, Suite 700 <br /> Chevy Chase, Maryland 20815</Link>
                           </div>
                        </div>
                        <div className="contact-info-item d-flex align-items-center">
                           <div className="contact-icon">
                        ...
                        <div className="contact-info-item d-flex align-items-center">
                           ...
                           <div className="contact-loaction">
                              <Link to="tel:08778886664)">088 (778 886 664)</Link>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div className="col-xl-6 col-lg-6">
                     <div className="tpcontact">
                           ...
                           <h4 className="tp-contact-title mb-20">
                              <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                 ...
                                 <path
                                    ...
                                    fill="#171717" stroke="#0F0F0F" strokeWidth="0.2" />
                              </svg>
                              Fill the form
                           </h4>
                        </div>
                        <div className="tpcontact__form">
                           ...
                           <button className="tp-btn">Let,s Talk</button>
                        </div>
                     </div>
                  </div>
               </div>
