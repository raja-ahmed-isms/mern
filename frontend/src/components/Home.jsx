...
const Home = () => {
  const bannerImg = "assets/img/slider/slider-grident-bg.png";
  const caseStudyImg = "assets/img/case/case-grident-shape.png";
  const testimonialImg = "assets/img/testimonial/testi-border-shape.png";
  const blogImg = "assets/img/blog/blog-gridient-shape.png";
    ...
    <>
      <main>
                ...
                <div className="tp-slider-exprience">
                  ...
                  <div className="tp-slider-exprience__client-info d-flex align-items-center">
                    ...
                    <div className="tp-slider-exprience__meta">
                      ...
                      <span>
                        Founder of (Sixart <i className="fas fa-star"></i> - 5
                        star Agency)
                      </span>
                    </div>
                  </div>
              ...
              >
                <div className="service-section-wrapper">
                  ...
                  <div className="tp-service-content mb-20">
                    ...
                    <Link className="tp-btn" to="service.html">
                      See all Services
                    </Link>
                  </div>
                </div>
                ...
                <div className="row service-space-left">
                  ...
                  >
                    <div className="tp-service-item mb-20 d-flex justify-content-between">
                      ...
                      <div className="tp-service-item__icon">
                        <span>
                          <svg
                            width="32"
                            height="24"
                  ...
                  <div
                    ...
                    data-wow-delay=".9s"
                  >
                    <div className="tp-service-item sv-color-blue-one mb-20 d-flex justify-content-between">
                      <div className="tp-service-item__content">
                        <h4 className="tp-service-sm-title">
                          <Link to="service-details.html">
                  ...
                  <div
                    ...
                    data-wow-delay="1s"
                  >
                    <div className="tp-service-item sv-color-blue-two mb-20 d-flex justify-content-between">
                      <div className="tp-service-item__content">
                        <h4 className="tp-service-sm-title">
                          <Link to="service-details.html">
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${caseStudyImg})`,
          }}
            ...
            <div className="row justify-content-center">
              <div className="col-xl-6">
                <div className="tp-blog-section-title-box text-center mb-60">
                  ...
                  <h3 className="tp-section-title">Read our Latest stories </h3>
                </div>
              </div>
              <div className="row gx-20">
                <div
                ...
                >
                  <div className="tp-blog-item mb-30">
                    ...
                    <div className="tp-blog-item__tag">
                      <span>Tutorials</span>
                      <span className="tag-color-green">February. 20.2022</span>
                    </div>
